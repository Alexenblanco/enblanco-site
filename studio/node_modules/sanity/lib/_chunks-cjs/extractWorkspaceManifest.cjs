"use strict";
var jsxRuntime = require("react/jsx-runtime"), DOMPurify = require("isomorphic-dompurify"), startCase = require("lodash-es/startCase.js"), server = require("react-dom/server"), sanity = require("sanity"), compilerRuntime = require("react/compiler-runtime"), ui = require("@sanity/ui"), theme$1 = require("@sanity/ui/theme"), react = require("react"), reactIs = require("react-is");
...
const extractManifestTools = (tools) => tools.map((tool) => {
  ...
  try {
    const html = server.renderToString(/* @__PURE__ */ jsxRuntime.jsx(SchemaIcon, { ...props }));
    return DOMPurify__default.default.sanitize(html.trim(), config);
  } catch {
    return null;
  }
};
exports.extractCreateWorkspaceManifest = extractCreateWorkspaceManifest;
exports.resolveIcon = resolveIcon;
//# sourceMappingURL=extractWorkspaceManifest.cjs.map
