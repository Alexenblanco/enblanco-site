...
const VersionModeHeaderLayout = styled.header.withConfig({
  ...
  let t2;
  $[2] !== documentVersions ? (t2 = documentVersions.flatMap(_temp$L), $[2] = documentVersions, $[3] = t2) : t2 = $[3];
...
const Scroller$5 = styled.div.withConfig({
  ...
  const compareValue = useCompareValue(t1), {
    data: releases
  } = useActiveReleases(), [patchChannel] = useState(_temp$J);
  let t2;
...
function PaneLayout(props) {
  ...
  const [controller] = useState(_temp$I), [rootElement, setRootElement] = useState(null), width = useElementRect(rootElement)?.width || 0, collapsed = width === void 0 || !minWidth ? void 0 : width < minWidth;
  let t0;
...
const Image = styled.img.withConfig({
  ...
  let t2;
  $[8] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t2 = () => setOpen(_temp$C), $[8] = t2) : t2 = $[8];
...
function DocumentNotInReleaseBanner(t0) {
  ...
  let t12;
  $[31] !== handleAddToRelease || $[32] !== isScheduledRelease || $[33] !== t || $[34] !== tone || $[35] !== versionCreateState ? (t12 = isScheduledRelease ? void 0 : {
    text: t("banners.release.action.add-to-release"),
    tone,
    disabled: !!versionCreateState,
    onClick: handleAddToRelease,
    mode: "default"
  }, $[31] = handleAddToRelease, $[32] = isScheduledRelease, $[33] = t, $[34] = tone, $[35] = versionCreateState, $[36] = t12) : t12 = $[36];
  let t13;
  return $[37] !== t11 || $[38] !== t12 || $[39] !== tone ? (t13 = /* @__PURE__ */ jsx(Banner, { tone, content: t11, action: t12 }), $[37] = t11, $[38] = t12, $[39] = tone, $[40] = t13) : t13 = $[40], t13;
}
...
const TitleContainer = styled(Stack).withConfig({
  ...
  const $ = c(77), {
    ...
    title
  } = useDocumentTitle(), [patchChannel] = useState(_temp$B), isLocked = editState?.transactionSyncLock?.enabled, {
    t
  } = useTranslation(structureLocaleNamespace);
  let t0;
...
const FavoriteToggle = (t0) => {
  ...
  const activeViewNode = t4, prevDocumentIdRef = useRef(void 0);
  let t5, t6;
  ...
  }, t6 = [documentId, documentScrollElement], $[21] = documentId, $[22] = documentScrollElement, $[23] = t5, $[24] = t6) : (t5 = $[23], t6 = $[24]), useEffect(t5, t6);
  let t7, t8;
  $[25] !== portalElement || $[26] !== setDocumentPanelPortalElement ? (t7 = () => {
    portalElement && setDocumentPanelPortalElement(portalElement);
  }, t8 = [portalElement, setDocumentPanelPortalElement], $[25] = portalElement, $[26] = setDocumentPanelPortalElement, $[27] = t7, $[28] = t8) : (t7 = $[27], t8 = $[28]), useEffect(t7, t8);
  let t9;
  $[29] !== displayed || $[30] !== isInspectOpen || $[31] !== value ? (t9 = isInspectOpen ? /* @__PURE__ */ jsx(InspectDialog, { value: displayed || value }) : null, $[29] = displayed, $[30] = isInspectOpen, $[31] = value, $[32] = t9) : t9 = $[32];
  ...
  bb1: {
    if (params?.historyVersion) {
      let t133;
      $[37] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t133 = /* @__PURE__ */ jsx(ArchivedReleaseDocumentBanner, {}), $[37] = t133) : t133 = $[37], t12 = t133;
      break bb1;
    }
    let t132;
    ...
    if ($[40] !== editState || $[41] !== schemaType || $[42] !== selectedPerspective || $[43] !== workspace.document.drafts.enabled ? (isSelectedPerspectiveWriteable = isPerspectiveWriteable({
      ...
      let t153;
      $[46] !== isSelectedPerspectiveWriteable.reason || $[47] !== isSelectedPerspectiveWriteable.result || $[48] !== schemaType || $[49] !== selectedPerspective ? (t153 = !isSelectedPerspectiveWriteable.result && /* @__PURE__ */ jsx(ChooseNewDocumentDestinationBanner, { schemaType, selectedPerspective, reason: isSelectedPerspectiveWriteable.reason }), $[46] = isSelectedPerspectiveWriteable.reason, $[47] = isSelectedPerspectiveWriteable.result, $[48] = schemaType, $[49] = selectedPerspective, $[50] = t153) : t153 = $[50], t12 = t153;
      break bb1;
    }
    if (isPausedDraft && displayed?._id) {
      let t153;
      $[51] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t153 = /* @__PURE__ */ jsx(PausedScheduledDraftBanner, {}), $[51] = t153) : t153 = $[51], t12 = t153;
      break bb1;
    }
    ...
    if (selectedPerspective === "drafts" && scheduledCardinalityOneRelease && displayedIsDraft) {
      let t163;
      $[57] !== displayed || $[58] !== scheduledCardinalityOneRelease._id ? (t163 = /* @__PURE__ */ jsx(ScheduledDraftOverrideBanner, { releaseId: scheduledCardinalityOneRelease._id, draftDocument: displayed }), $[57] = displayed, $[58] = scheduledCardinalityOneRelease._id, $[59] = t163) : t163 = $[59], t12 = t163;
      break bb1;
    }
    let t162;
    ...
    if (!isSystemBundle(selectedPerspective) && displayed?._id && getVersionFromId(displayed._id) !== selectedPerspectiveName && ready && !isPinnedDraftOrPublish && isNewDocument(editState) === !1 && !isCurrentVersionGoingToUnpublish) {
      let t172;
      $[62] !== isScheduledRelease || $[63] !== selectedPerspective || $[64] !== value._id ? (t172 = /* @__PURE__ */ jsx(DocumentNotInReleaseBanner, { documentId: value._id, currentRelease: selectedPerspective, isScheduledRelease }), $[62] = isScheduledRelease, $[63] = selectedPerspective, $[64] = value._id, $[65] = t172) : t172 = $[65], t12 = t172;
      break bb1;
    }
    ...
    if (activeView.type === "form" && !selectedReleaseId && displayedHasObsoleteDraft.result) {
      if (displayedHasObsoleteDraft.reason === "DRAFT_MODEL_INACTIVE") {
        let t172;
        $[66] !== displayed || $[67] !== documentId || $[68] !== schemaType ? (t172 = /* @__PURE__ */ jsx(ObsoleteDraftBanner, { displayed, documentId, schemaType, i18nKey: "banners.obsolete-draft.draft-model-inactive.text" }), $[66] = displayed, $[67] = documentId, $[68] = schemaType, $[69] = t172) : t172 = $[69], t12 = t172;
        break bb1;
      }
      if (displayedHasObsoleteDraft.reason === "LIVE_EDIT_ACTIVE") {
        let t172;
        $[70] !== displayed || $[71] !== documentId || $[72] !== schemaType ? (t172 = /* @__PURE__ */ jsx(ObsoleteDraftBanner, { displayed, documentId, schemaType, i18nKey: "banners.live-edit-draft-banner.text", isEditBlocking: !0 }), $[70] = displayed, $[71] = documentId, $[72] = schemaType, $[73] = t172) : t172 = $[73], t12 = t172;
        break bb1;
      }
    }
    ...
    let t17;
    $[74] !== showCreateBanner ? (t17 = showCreateBanner && /* @__PURE__ */ jsx(CreateLinkedBanner, {}), $[74] = showCreateBanner, $[75] = t17) : t17 = $[75];
    let t18;
  ...
  let t14;
  $[94] !== activeViewNode || $[95] !== banners || $[96] !== documentScrollElement || $[97] !== footer || $[98] !== formViewHidden || $[99] !== inspectDialog || $[100] !== layoutCollapsed || $[101] !== margins || $[102] !== portalElement || $[103] !== portalElements || $[104] !== showFormView ? (t14 = showFormView && /* @__PURE__ */ jsxs(Flex, { height: "fill", direction: "column", width: "fill", flex: 2, children: [
  ...
  let t15;
  $[106] !== documentId || $[107] !== rootElement || $[108] !== schemaType || $[109] !== showInspector ? (t15 = showInspector && /* @__PURE__ */ jsx(BoundaryElementProvider, { element: rootElement, children: /* @__PURE__ */ jsx(DocumentInspectorPanel, { documentId, documentType: schemaType.name, flex: 1 }) }), $[106] = documentId, $[107] = rootElement, $[108] = schemaType, $[109] = showInspector, $[110] = t15) : t15 = $[110];
  let t16;
  return $[111] !== t14 || $[112] !== t15 ? (t16 = /* @__PURE__ */ jsx(PaneContent, { children: /* @__PURE__ */ jsxs(Flex, { height: "fill", children: [
    t14,
    t15
...
function CopyDocumentActions() {
  ...
  let t1;
  $[5] !== buildStudioUrl || $[6] !== documentId || $[7] !== documentType || $[8] !== pushToast || $[9] !== resolveIntentLink || $[10] !== scheduledDraft || $[11] !== selectedReleaseId || $[12] !== t || $[13] !== telemetry ? (t1 = async () => {
  ...
  }, $[5] = buildStudioUrl, $[6] = documentId, $[7] = documentType, $[8] = pushToast, $[9] = resolveIntentLink, $[10] = scheduledDraft, $[11] = selectedReleaseId, $[12] = t, $[13] = telemetry, $[14] = t1) : t1 = $[14];
...
function usePreviewUrl(value) {
  ...
  return $[4] !== resolveProductionUrl ? (t3 = subject.asObservable().pipe(distinctUntilChanged$1(), debounceTime(500), switchMap((document2) => isSanityDocument(document2) ? from(resolveProductionUrl({
    document: document2
  })) : of(void 0)), distinctUntilChanged$1(), catchError$1(_temp$m)), $[4] = resolveProductionUrl, $[5] = t3) : t3 = $[5], useObservable(t3);
}
...
function DocumentPaneProvider(props) {
  ...
  }), !0) : item.action === "toggleInlineChanges" ? (toggleInlineChanges(), !0) : !1), $[103] = diffViewRouter, $[104] = documentType, $[105] = handleHistoryOpen, $[106] = handleInspectorAction, $[107] = previewUrl, $[108] = previousId, $[109] = toggleInlineChanges, $[110] = value_0._id, $[111] = t35) : t35 = $[111];
  ...
  }, t37 = [documentId, documentType, schemaType, onChange, setDocumentMeta], $[112] = documentId, $[113] = documentType, $[114] = onChange, $[115] = schemaType, $[116] = setDocumentMeta, $[117] = t36, $[118] = t37) : (t36 = $[117], t37 = $[118]), useEffect(t36, t37);
  let t38;
  ...
  $[124] !== actions || $[125] !== activeViewId || $[126] !== badges || $[127] !== changesOpen || $[128] !== closeInspector || $[129] !== collapsedFieldSets || $[130] !== collapsedPaths || $[131] !== compareValue || $[132] !== connectionState || $[133] !== currentDisplayed || $[134] !== documentId || $[135] !== documentIdRaw || $[136] !== documentType || $[137] !== editState_1 || $[138] !== fieldActions || $[139] !== focusPath || $[140] !== formState || $[141] !== handleHistoryClose || $[142] !== handleHistoryOpen || $[143] !== handleLegacyInspectClose || $[144] !== handleMenuAction || $[145] !== handlePaneClose || $[146] !== handlePaneSplit || $[147] !== handlePathOpen || $[148] !== hasUpstreamVersion || $[149] !== index || $[150] !== inspectOpen || $[151] !== inspectors2 || $[152] !== isDeleted_1 || $[153] !== isDeleting || $[154] !== isInitialValueLoading || $[155] !== isPermissionsLoading || $[156] !== languageFilter || $[157] !== lastNonDeletedRevId || $[158] !== lastRevisionDocument || $[159] !== maximized || $[160] !== onBlur || $[161] !== onChange || $[162] !== onFocus || $[163] !== onSetActiveFieldGroup || $[164] !== onSetCollapsedFieldSet || $[165] !== onSetCollapsedPath || $[166] !== onSetMaximizedPane || $[167] !== openInspector || $[168] !== openPath || $[169] !== paneKey || $[170] !== permissions || $[171] !== previewUrl || $[172] !== ready || $[173] !== revisionId || $[174] !== revisionNotFound || $[175] !== schemaType || $[176] !== selectedReleaseId || $[177] !== setTimelineRange || $[178] !== t40 || $[179] !== t41 || $[180] !== timelineError || $[181] !== timelineStore || $[182] !== title || $[183] !== validation || $[184] !== value_0 || $[185] !== views ? (t42 = {
    ...
    lastNonDeletedRevId,
    lastRevisionDocument
  }, $[124] = actions, $[125] = activeViewId, $[126] = badges, $[127] = changesOpen, $[128] = closeInspector, $[129] = collapsedFieldSets, $[130] = collapsedPaths, $[131] = compareValue, $[132] = connectionState, $[133] = currentDisplayed, $[134] = documentId, $[135] = documentIdRaw, $[136] = documentType, $[137] = editState_1, $[138] = fieldActions, $[139] = focusPath, $[140] = formState, $[141] = handleHistoryClose, $[142] = handleHistoryOpen, $[143] = handleLegacyInspectClose, $[144] = handleMenuAction, $[145] = handlePaneClose, $[146] = handlePaneSplit, $[147] = handlePathOpen, $[148] = hasUpstreamVersion, $[149] = index, $[150] = inspectOpen, $[151] = inspectors2, $[152] = isDeleted_1, $[153] = isDeleting, $[154] = isInitialValueLoading, $[155] = isPermissionsLoading, $[156] = languageFilter, $[157] = lastNonDeletedRevId, $[158] = lastRevisionDocument, $[159] = maximized, $[160] = onBlur, $[161] = onChange, $[162] = onFocus, $[163] = onSetActiveFieldGroup, $[164] = onSetCollapsedFieldSet, $[165] = onSetCollapsedPath, $[166] = onSetMaximizedPane, $[167] = openInspector, $[168] = openPath, $[169] = paneKey, $[170] = permissions, $[171] = previewUrl, $[172] = ready, $[173] = revisionId, $[174] = revisionNotFound, $[175] = schemaType, $[176] = selectedReleaseId, $[177] = setTimelineRange, $[178] = t40, $[179] = t41, $[180] = timelineError, $[181] = timelineStore, $[182] = title, $[183] = validation, $[184] = value_0, $[185] = views, $[186] = t42) : t42 = $[186];
  ...
  $[187] !== formStateRef || $[188] !== onProgrammaticFocus || $[189] !== openPath || $[190] !== params || $[191] !== ready ? (t43 = () => {
    if (ready && params.path) {
      const {
        path: path_0
      } = params, currentOpenPathString = pathToString(openPath);
  ...
  let t44;
  $[193] !== formStateRef || $[194] !== onProgrammaticFocus || $[195] !== openPath || $[196] !== paneRouter || $[197] !== params || $[198] !== ready ? (t44 = [formStateRef, onProgrammaticFocus, paneRouter, params, ready, !0, openPath], $[193] = formStateRef, $[194] = onProgrammaticFocus, $[195] = openPath, $[196] = paneRouter, $[197] = params, $[198] = ready, $[199] = t44) : t44 = $[199], useEffect(t43, t44);
  let t45;
...
const EllipsisText = styled(Text).withConfig({
  ...
  let t11;
  $[27] !== documentVariant || $[28] !== release?.metadata?.title || $[29] !== systemTitle || $[30] !== versionId ? (t11 = documentVariant === "version" ? /* @__PURE__ */ jsx(ReleaseTitle, { title: release?.metadata?.title, fallback: getVersionFromId(versionId), children: _temp$h }) : /* @__PURE__ */ jsx(EllipsisText, { size: 1, weight: "medium", textOverflow: "ellipsis", children: systemTitle }), $[27] = documentVariant, $[28] = release?.metadata?.title, $[29] = systemTitle, $[30] = versionId, $[31] = t11) : t11 = $[31];
  let t12;
