    ...
    <>
      ...
      <main id="main" className="overflow-x-hidden bg-[var(--color-bg)]">
        <section
          ...
          className="relative min-h-[100svh] px-8 pb-0 pt-6 [--footer-logo-top:42px] [--footer-logo-width:calc(100vw-64px)] [--footer-logo-height:calc(var(--footer-logo-width)*18.3/99.4)] [--home-logo-copy-gap:clamp(180px,26vw,500px)] md:[--footer-logo-top:52px] md:[--home-logo-copy-gap:clamp(190px,min(22svh,20vw),380px)] xl:[--footer-logo-top:56px]"
        >
