...
/** Notas de ejemplo para la tabla. Sustituir por CMS/API. Tipos: decisión, reflexión, criterio, pensamiento, observación. */
const NOTAS_ES = [
  {
    slug: "ejemplo",
    index: "01",
    type: "criterio" as const,
    ...
    <main className="mx-auto max-w-5xl px-6 py-10">
      ...
      <header className="mb-10 grid gap-6 md:grid-cols-2">
        ...
        <div className="space-y-2 text-sm text-zinc-700">
          <p>
            notas sobre creatividad, diseño y procesos de marca en enblanco.
          </p>
          <p>
            una colección de decisiones, matices y criterios aplicados en el trabajo de enblanco.
          </p>
        </div>
      </header>

      <section aria-labelledby="indice-heading" className="mb-12">
        <h2 id="indice-heading" className="sr-only text-base font-semibold tracking-tight">
          índice de notas
        </h2>
            ...
            <tbody>
              {NOTAS_ES.length > 0 ? (
                NOTAS_ES.map((nota) => (
                  ...
                  >
                    ...
                    <td className="py-3 pr-4 font-medium text-zinc-900">
                      <Link href={`/es/notas/${nota.slug}`} className="underline hover:no-underline">
                        {nota.title}
                      </Link>
                    </td>
                ...
                <tr className="border-b border-zinc-100">
                  <td colSpan={5} className="py-6 pr-4 text-center text-sm text-zinc-500">
      ...
      <section aria-labelledby="relaciones-heading" className="mt-8">
        <h2 id="relaciones-heading" className="text-base font-semibold tracking-tight">
          más en enblanco
        </h2>
        <p className="mt-2 text-sm text-zinc-700">
          ...
          <Link href="/es/enblanco" className="underline">enblanco</Link>,{" "}
