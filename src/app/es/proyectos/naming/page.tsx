...
const slug: EsProyectosCollectionSlug = "naming";
const title = ES_COLLECTION_TITLES[slug];

export const metadata: Metadata = {
  title,
  description: "Proyectos de naming de enblanco: nombres que encajan con la estrategia.",
  alternates: { canonical: `/es/proyectos/${slug}`, languages: { es: `/es/proyectos/${slug}`, en: "/en/projects/naming", "x-default": `/es/proyectos/${slug}` } },
};
    ...
    <main className="mx-auto max-w-5xl px-6 py-10">
      ...
      <header className="mb-10">
        ...
        <p className="mt-2 max-w-2xl text-sm text-zinc-700">
          Trabajos de naming. Explorar por <Link href="/es/areas" className="underline">área</Link> o <Link href="/es/servicios/naming" className="underline">servicio de naming</Link>.
        </p>
      </header>
      ...
      <p className="text-sm text-zinc-600">
        Otras colecciones: {ES_SERVICE_SLUGS.filter((s) => s !== slug).map((s) => (
