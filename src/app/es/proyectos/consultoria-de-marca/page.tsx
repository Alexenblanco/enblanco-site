...
const slug: EsProyectosCollectionSlug = "consultoria-de-marca";
const title = ES_COLLECTION_TITLES[slug];

export const metadata: Metadata = {
  title,
  description: "Proyectos de consultoría de marca de enblanco.",
  alternates: { canonical: `/es/proyectos/${slug}`, languages: { es: `/es/proyectos/${slug}`, en: "/en/projects/brand-consulting", "x-default": `/es/proyectos/${slug}` } },
};
    ...
    <main className="mx-auto max-w-5xl px-6 py-10">
      ...
      <header className="mb-10">
        ...
        <p className="mt-2 max-w-2xl text-sm text-zinc-700">
          Explorar por <Link href="/es/areas" className="underline">área</Link> o <Link href="/es/servicios/consultoria-de-marca" className="underline">servicio</Link>.
        </p>
      </header>
