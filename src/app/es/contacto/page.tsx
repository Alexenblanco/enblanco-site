  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-10">
      ...
      <section id="datos-contacto" aria-labelledby="datos-heading" className="mb-10">
        <h2 id="datos-heading" className="text-base font-semibold tracking-tight">
          Datos de contacto
        </h2>
        <p className="mt-2 text-sm text-zinc-700">
          ...
          {" · "}
          <a href="tel:+349681234567" className="underline">
            +34 968 12 34 56
          </a>
        </p>
      </section>
      ...
      <section id="oficinas" aria-labelledby="oficinas-heading" className="mb-10">
        <h2 id="oficinas-heading" className="text-base font-semibold tracking-tight">
          Oficinas
        </h2>
        <div className="mt-3 grid gap-6 text-sm text-zinc-700 sm:grid-cols-2">
          <address className="not-italic">
            <strong className="text-zinc-900">Murcia</strong>
            <br />
            Calle ejemplo, 1
            <br />
            30001 Murcia
          ...
          <address className="not-italic">
            <strong className="text-zinc-900">Madrid</strong>
            <br />
            Calle ejemplo, 2
            <br />
            28001 Madrid
      ...
      <section id="formulario" aria-labelledby="form-heading" className="border-t border-zinc-200 pt-8">
        <h2 id="form-heading" className="text-base font-semibold tracking-tight">
          Envíanos un mensaje
        </h2>
        <form
          action="#"
        ...
        >
          <div>
            <label htmlFor="contacto-nombre" className="block text-sm font-medium text-zinc-800">
              Nombre
            </label>
            <input
              id="contacto-nombre"
              ...
              required
              autoComplete="name"
              className="mt-1 w-full max-w-md rounded border border-zinc-300 px-3 py-2 text-sm text-zinc-900"
            />
          </div>
          <div>
            <label htmlFor="contacto-email" className="block text-sm font-medium text-zinc-800">
              Email
            </label>
            <input
              id="contacto-email"
          ...
          <div>
            <label htmlFor="contacto-mensaje" className="block text-sm font-medium text-zinc-800">
              Cuéntanos
            </label>
            <textarea
              id="contacto-mensaje"
