  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-10">
      ...
      <section id="descubrimiento" aria-labelledby="descubrimiento-heading" className="mb-8">
        <h2 id="descubrimiento-heading" className="text-base font-semibold tracking-tight">
          descubrimiento
        </h2>
      ...
      <section id="estrategia" aria-labelledby="estrategia-heading" className="mb-8">
        <h2 id="estrategia-heading" className="text-base font-semibold tracking-tight">
          estrategia
        </h2>
        <p className="mt-2 text-sm text-zinc-700">
      ...
      <section id="creatividad-y-diseno" aria-labelledby="creatividad-heading" className="mb-8">
        <h2 id="creatividad-heading" className="text-base font-semibold tracking-tight">
      ...
      <section id="produccion-y-lanzamiento" aria-labelledby="produccion-heading" className="mb-8">
        <h2 id="produccion-heading" className="text-base font-semibold tracking-tight">
