    ...
    <main className="mx-auto max-w-5xl px-6 py-10">
      ...
      <header className="mb-10 grid gap-6 md:grid-cols-2">
        ...
        <div className="space-y-2 text-sm text-zinc-700">
          <p>
            notes on creativity, design, and brand process at enblanco.
          </p>
          <p>
            a collection of decisions, nuances, and criteria applied in enblanco&apos;s work.
          </p>
        </div>
      </header>

      <section aria-labelledby="index-heading" className="mb-12">
        <h2 id="index-heading" className="sr-only text-base font-semibold tracking-tight">
          notes index
        </h2>
                ...
                NOTES_EN.map((note) => (
                  ...
                  >
                    ...
                    <td className="py-3 pr-4 font-medium text-zinc-900">
                      <Link href={`/en/notes/${note.slug}`} className="underline hover:no-underline">
                        {note.title}
                      </Link>
                    </td>
      ...
      <section aria-labelledby="relations-heading" className="mt-8">
        ...
        <p className="mt-2 text-sm text-zinc-700">
          ...
          <Link href="/en/enblanco" className="underline">enblanco</Link>,{" "}
