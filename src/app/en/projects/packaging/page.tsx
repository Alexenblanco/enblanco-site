...
const slug: EnProjectsCollectionSlug = "packaging";
const title = EN_COLLECTION_TITLES[slug];

export const metadata: Metadata = {
  title,
  description: "enblanco packaging projects.",
  alternates: { canonical: `/en/projects/${slug}`, languages: { es: "/es/proyectos/packaging", en: `/en/projects/${slug}`, "x-default": "/es/proyectos/packaging" } },
};
    ...
    <main className="mx-auto max-w-5xl px-6 py-10">
      ...
      <header className="mb-10">
        ...
        <p className="mt-2 max-w-2xl text-sm text-zinc-700">
          Explore by <Link href="/en/areas" className="underline">area</Link> (e.g. <Link href="/en/areas/food" className="underline">food</Link>, <Link href="/en/areas/retail" className="underline">retail</Link>) or <Link href="/en/services/packaging" className="underline">service</Link>.
        </p>
      </header>
