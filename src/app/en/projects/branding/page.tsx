...
const slug: EnProjectsCollectionSlug = "branding";
const title = EN_COLLECTION_TITLES[slug];

export const metadata: Metadata = {
  title,
  description: "enblanco branding projects: clear, applicable brand systems.",
  alternates: { canonical: `/en/projects/${slug}`, languages: { es: "/es/proyectos/branding", en: `/en/projects/${slug}`, "x-default": "/es/proyectos/branding" } },
};
    ...
    <main className="mx-auto max-w-5xl px-6 py-10">
      ...
      <header className="mb-10">
        ...
        <p className="mt-2 max-w-2xl text-sm text-zinc-700">
          Explore by <Link href="/en/areas" className="underline">area</Link> or <Link href="/en/services/branding" className="underline">branding service</Link>.
        </p>
      </header>
