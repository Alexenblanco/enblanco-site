...
const slug: EnProjectsCollectionSlug = "web-design";
const title = EN_COLLECTION_TITLES[slug];

export const metadata: Metadata = {
  title,
  description: "enblanco web design projects.",
  alternates: { canonical: `/en/projects/${slug}`, languages: { es: "/es/proyectos/diseno-web", en: `/en/projects/${slug}`, "x-default": "/es/proyectos/diseno-web" } },
};
    ...
    <main className="mx-auto max-w-5xl px-6 py-10">
      ...
      <header className="mb-10">
        ...
        <p className="mt-2 max-w-2xl text-sm text-zinc-700">
          Explore by <Link href="/en/areas" className="underline">area</Link> or <Link href="/en/services/web-design" className="underline">service</Link>.
        </p>
      </header>
