...
const slug: EnProjectsCollectionSlug = "art-direction";
const title = EN_COLLECTION_TITLES[slug];

export const metadata: Metadata = {
  title,
  description: "enblanco art direction projects.",
  alternates: { canonical: `/en/projects/${slug}`, languages: { es: "/es/proyectos/direccion-de-arte", en: `/en/projects/${slug}`, "x-default": "/es/proyectos/direccion-de-arte" } },
};
    ...
    <main className="mx-auto max-w-5xl px-6 py-10">
      ...
      <header className="mb-10">
        ...
        <p className="mt-2 max-w-2xl text-sm text-zinc-700">
          Explore by <Link href="/en/areas" className="underline">area</Link> or <Link href="/en/services/art-direction" className="underline">service</Link>.
        </p>
      </header>
