  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-10">
      ...
      <div className="prose prose-zinc prose-sm mt-6 max-w-none text-zinc-700">
        <p>Este aviso legal regula el uso del sitio web de enblanco. El titular del sitio es la entidad que figura como responsable en el pie de página. El acceso y uso del sitio implica la aceptación de las presentes condiciones.</p>
        <p>Contenido placeholder. Sustituir por el texto legal definitivo redactado o revisado por un profesional.</p>
      </div>
