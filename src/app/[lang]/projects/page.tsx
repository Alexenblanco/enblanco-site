  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-10">
      ...
      <section id="selection" aria-labelledby="selection-heading" className="mb-10">
        <h2 id="selection-heading" className="text-base font-semibold tracking-tight">selection</h2>
      ...
      <section id="explore-by-service" aria-labelledby="por-servicio-heading" className="mb-10">
        <h2 id="por-servicio-heading" className="text-base font-semibold tracking-tight">explore by service</h2>
        ...
        <ul className="flex flex-wrap gap-2 text-sm">
          {services.map((s) => (
            <li key={s.slug}>
              <Link href={withLang("en", `projects/${s.slug}`)} className="text-zinc-900 underline hover:no-underline">
                {s.name}
              </Link>
      ...
      <section id="explore-by-area" aria-labelledby="por-area-heading" className="mb-10">
        <h2 id="por-area-heading" className="text-base font-semibold tracking-tight">explore by area</h2>
        <p className="mt-2 mb-4 max-w-2xl text-sm text-zinc-700">
        ...
        <ul className="flex flex-wrap gap-2 text-sm">
          {areas.map((a) => (
            <li key={a.slug}>
              <Link href={withLang("en", `areas/${a.slug}#related-projects`)} className="text-zinc-900 underline hover:no-underline">
                {a.name}
              </Link>
      ...
      <section id="contact" aria-labelledby="contacto-heading" className="mb-8">
        <h2 id="contacto-heading" className="text-base font-semibold tracking-tight">contact</h2>
