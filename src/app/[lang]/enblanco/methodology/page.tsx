...
export default async function MethodologyPage({ params }: Props) {
  ...
  if (lang === "es") redirect(withLang("es", "enblanco/metodologia"));
  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-10">
      ...
      <section id="discovery" aria-labelledby="discovery-heading" className="mb-8">
        <h2 id="discovery-heading" className="text-base font-semibold tracking-tight">discovery</h2>
      ...
      <section id="strategy" aria-labelledby="strategy-heading" className="mb-8">
        <h2 id="strategy-heading" className="text-base font-semibold tracking-tight">strategy</h2>
        <p className="mt-2 text-sm text-zinc-700">
      ...
      <section id="creativity-and-design" aria-labelledby="creativity-heading" className="mb-8">
        <h2 id="creativity-heading" className="text-base font-semibold tracking-tight">creativity &amp; design</h2>
        <p className="mt-2 text-sm text-zinc-700">
      ...
      <section id="production-and-launch" aria-labelledby="production-heading" className="mb-8">
        <h2 id="production-heading" className="text-base font-semibold tracking-tight">production &amp; launch</h2>
        <p className="mt-2 text-sm text-zinc-700">
